                ...
                <Row className="align-items-top">
                    <Col sm="6">
                        <Table borderless className="tabla  w-100">
                            <thead>
                                <tr>
                                    <th id="titulo" colSpan="2">Datos Personales</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td>Correos:</td>
                                    <td>
                                        wasantac12349@gmail.com
                                        waltersantacruz@hotmail.es
                                    </td>
                                </tr>
                            </tbody>
                        </Table>
                    ...
                    <Col sm="6">
                        ...
                        <p className="blanco-light text-justify">Soy una persona muy proactiva,muy divertido (Siempre Facha) y un gran líder cuando se lo requiere. Me gusta mucho la programación y ahora estoy emprendiendo nuevos retos desde que aprendí a programar en web framworks para hacer páginas web. Me gusta mucho el anime siendo mi favorito Jojo's Bizzarre Adventure y también me gusta armar cubos de rubik.</p>
                    ...
                    <Col sm="6">
                        ...
                        <p className="blanco-light text-justify">Culminé mis estudios de primaria y secundaria en el prestigioso Colegio Americano. Ahí aprendí mucho inglés el cual me ha ayudado mucho ya que obtuve un certificado de B2 del bachillerato internacional. Me gradué de Bachiller en Ciencias.</p>
                    </Col>
                    <Col sm="6">
